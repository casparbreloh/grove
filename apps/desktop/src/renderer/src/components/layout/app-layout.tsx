...
function MainPaneHeader() {
  ...
  return (
    <header className="relative flex h-10 shrink-0 items-center bg-background [-webkit-app-region:drag]">
      <span
        className="flex h-8 translate-x-0 items-center gap-2 pr-3 pl-3 text-ui-small font-medium transition-transform duration-150 ease-linear motion-reduce:transition-none data-[app-sidebar-open=false]:translate-x-[calc(var(--desktop-header-controls-width)-0.75rem)]"

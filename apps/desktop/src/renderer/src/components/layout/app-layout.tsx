...
function AppTitlebarControls() {
  return (
    <div className="fixed top-0 left-0 z-20 flex h-10 items-center gap-1 pr-1 pl-[calc(var(--desktop-header-safe-area-left)+0.5rem)] [-webkit-app-region:no-drag]">
      ...
      <span className="invisible opacity-0 transition-opacity duration-150 motion-reduce:transition-none group-data-[state=collapsed]/sidebar-wrapper:visible group-data-[state=collapsed]/sidebar-wrapper:opacity-100">
        <DropdownMenu>
          <DropdownMenuTrigger

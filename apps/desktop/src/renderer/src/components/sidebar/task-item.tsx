  ...
  return (
    <li className="group/task-item relative">
      ...
      <Button
        ...
        className="pointer-events-none absolute right-1.5 bottom-1 h-5 gap-1 px-1 text-[11px]! text-muted-foreground opacity-0 transition-opacity group-hover/task-item:pointer-events-auto group-hover/task-item:opacity-100 hover:bg-transparent hover:text-foreground focus-visible:pointer-events-auto focus-visible:opacity-100 dark:hover:bg-transparent"
        size="xs"
        variant="ghost"
      >

...
function AssistantMessage() {
  return (
    <MessagePrimitive.Root
      className="fade-in slide-in-from-bottom-1 animate-in px-2 text-sm/relaxed duration-150 motion-reduce:animate-none [contain-intrinsic-size:auto_200px] [content-visibility:auto]"
      data-role="assistant"

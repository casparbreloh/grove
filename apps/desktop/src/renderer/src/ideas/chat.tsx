import { ArrowUp02Icon, File01Icon } from "@hugeicons/core-free-icons";
    ...
    >
      <MessageScrollerProvider autoScroll defaultScrollPosition="end">
        <MessageScroller className="flex-1">
          <MessageScrollerViewport className="overscroll-y-none">
            <MessageScrollerContent
              className="mx-auto w-full max-w-3xl px-6 pt-8 sm:px-10"
              style={{ paddingBottom: "calc(var(--composer-height, 0px) + 8px)" }}
            >
          ...
          <MessageScrollerButton
            style={{ bottom: "max(calc(var(--composer-height, 0px) - 40px), 8px)" }}
          />
        </MessageScroller>
      </MessageScrollerProvider>
      ...
      >
        ...
        />
        <form
          className="pointer-events-auto relative mx-auto max-w-3xl rounded-3xl border bg-card p-2 shadow-xs focus-within:border-ring focus-within:ring-2 focus-within:ring-ring/20"
          onSubmit={(event) => {
        ...
        >
          <Textarea
            aria-label="Message"
            className="max-h-40 min-h-11 overflow-y-auto overscroll-y-none border-0 bg-transparent px-2 py-2 shadow-none focus-visible:border-transparent focus-visible:ring-0 dark:bg-transparent"
